    ...
    public function run(): void
    {
        ...
        $programs = [
            [
                ...
                'status'            => 'published',
                'registration_link' => 'https://alumni-steman.my.id/daftar/beasiswa',
            ],
            [
                ...
                'status'            => 'published',
                'registration_link' => 'https://alumni-steman.my.id/daftar/mentoring',
            ],
            [
                'title'             => 'Social Impact',
                'slug'              => 'social-impact',
                ...
                'icon'              => 'bi-heart-fill',
                'status'            => 'published',
                'registration_link' => 'https://alumni-steman.my.id/daftar/social',
            ],
        ];
