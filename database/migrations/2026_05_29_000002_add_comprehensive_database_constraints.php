...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('feeds', function (Blueprint $table) {
            if (!Schema::hasIndex('feeds', 'idx_feeds_user_id')) {
        ...
        Schema::table('likes', function (Blueprint $table) {
            if (!Schema::hasIndex('likes', 'idx_likes_feed_id')) {
                $table->index('feed_id', 'idx_likes_feed_id');
            }
            if (!Schema::hasIndex('likes', 'idx_likes_user_id')) {
                $table->index('user_id', 'idx_likes_user_id');
            }
            // Add unique constraint to prevent duplicate likes
            if (!Schema::hasIndex('likes', 'unique_user_feed')) {
