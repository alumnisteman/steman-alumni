...
Route::middleware(['auth', 'verified_alumni', 'throttle:global'])->group(function () {
    ...
    Route::get('/pending-notice', function () {
        ...
        // Alumni Stories
        Route::get('/stories', function () { return redirect('/feed'); });
        Route::get('/stories/{story}', [\App\Http\Controllers\StoryController::class, 'showShared'])->name('stories.show');
        Route::post('/stories', [\App\Http\Controllers\StoryController::class, 'store'])->name('stories.store');
        Route::post('/stories/note', [\App\Http\Controllers\StoryController::class, 'storeNote'])->name('stories.note');
