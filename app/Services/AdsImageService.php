...
class AdsImageService
{
     ...
     */
    public function process(UploadedFile $file, string $position, bool $isMobile = false): string
    {
        try {
            ...
            // Apply cover (resize & center crop)
            $img->cover($w, $h, 'center');
     ...
     */
    public function autoGenerateMobile(string $desktopPath, string $position): ?string
    {
        try {
