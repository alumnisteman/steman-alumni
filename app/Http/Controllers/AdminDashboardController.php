...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        return view('admin.dashboard', compact(
            'totalAlumni', 'totalAdmins', 'totalMajors', 'totalPrograms', 'totalJobs',
            'alumniByMajor', 'alumniByYear', 'recentActivities', 'aiInsights', 
            'alumniLocations', 'nationalCount', 'internationalCount'
        ));
    }
